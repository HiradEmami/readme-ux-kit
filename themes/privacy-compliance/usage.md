# Privacy Compliance Usage

## Do

- Use this theme for privacy tooling, compliance programs, policy docs, and data-boundary projects.
- Keep the writing cautious, accountable, plain-language.
- Use `low` motion and `medium` density consistently.

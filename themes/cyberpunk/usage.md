...
- Use this theme for security, devops, infrastructure, and high-energy tools.
- Keep the writing sharp, alert, system-focused.
- Use `high` motion and `medium` density consistently.

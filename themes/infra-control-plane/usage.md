# Infra Control Plane Usage

## Do

- Use this theme for infrastructure, clusters, iac, platform ops, and deployment systems.
- Keep the writing systems-oriented, exact, risk-aware.
- Use `moderate` motion and `dense` density consistently.

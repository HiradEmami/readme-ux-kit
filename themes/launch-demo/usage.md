...
- Use this theme for demos, prototypes, examples, launches, and product walkthroughs.
- Keep the writing action-led, concrete, fast.
- Use `high` motion and `light` density consistently.

# Reliability Ops Usage

## Do

- Use this theme for sre, uptime, incident, and production readiness readmes.
- Keep the writing operational, factual, no-drama.
- Use `low` motion and `dense` density consistently.
